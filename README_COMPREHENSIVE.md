...
A **completely standalone UEFI application** that performs system shutdown via ACPI.
...
✅ **Cross-Platform Builder** - `build_shutdown.sh` detects Linux vs macOS
...
- ✅ **Host OS Detection** - Adjusts for Linux and macOS toolchains
